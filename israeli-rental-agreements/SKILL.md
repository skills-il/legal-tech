...
| Maximum deposit / guarantee (section 25י) | Capped at the LOWER of (a) 3 months' rent OR (b) one-third of the total lease value (one-third of the lease term in rent). Not a flat 3 months |
| Written contract required (section 25ב) | A residential lease must be made IN WRITING, signed by both parties, with each party receiving a signed copy. This is the statutory norm, not merely a recommendation. (As a secondary nuance, an oral lease is not automatically void, but it falls short of the statutory form and is extremely hard to enforce) |
| Landlord pre-contract disclosure (section 25ב) | Before signing, the landlord must disclose any defect known to them in the apartment that is not minor, AND anything in the apartment or its surroundings, known to the landlord at contract formation, that causes or is likely to cause material disruption (hafra'a shel mamash) to the use of the apartment |
| Termination notice | Must follow contract terms; typically 60-90 days. Under the standard model the notice periods are asymmetric: the landlord gives 90 days, the tenant gives 60 days |
...
**Note on scope:** the 90-day-landlord / 60-day-tenant notice periods, the deposit cap, and the repair duties are all part of the section 25 chapter and are therefore subject to the section 25טו exclusions below. They do NOT apply to a section 25טו-excluded lease (rent above 20,000 NIS/month, lease over 10 years, lease under 3 months, family rentals, hotels and vacation lets, assisted living, dormitories, or protected tenancies).

**When the fair-rental provisions do NOT apply (section 25טו exclusions):** the residential-rental chapter does not cover every lease. The deposit cap, repair duties, and notice rules do NOT apply when any of the following is true:

| Exclusion | Details |
|-----------|---------|
| High rent | Monthly rent above 20,000 NIS (this figure is not index-linked) |
| Long lease | Lease longer than 10 years |
| Very short lease | Lease shorter than 3 months (and no option to extend past 3 months) |
| Family rental | Rental between family members |
...
| Protected tenancy | Units under the Tenant Protection Law (diyrut mugenet) |

Do NOT over-apply the deposit cap or the landlord repair duties to a lease that falls into any of these categories.

**Broker fee (section 25ט):** a residential tenant cannot be charged the broker's fee when the broker acted on the landlord's behalf. The landlord and tenant cannot agree in the contract that the tenant will pay the landlord's share of the broker's fee. A clause that shifts the landlord's broker fee onto the tenant is void.
...
| Maximum allowed (section 25י) | The LOWER of (a) 3 months' rent OR (b) one-third of the total lease value (one-third of the lease term, measured in rent). For a 12-month lease this works out to 3 months; for a shorter lease the one-third cap binds first (a 6-month lease caps at 2 months) |
| Return timeline | Within 60 days of the tenant vacating the apartment (or settling any outstanding debts, whichever is later), per the fair-rental provisions |
...
| Pre-contract disclosure duty (section 25ב) | Before signing, the landlord must disclose any non-minor defect known to them in the apartment, AND anything in the apartment or its surroundings, known to the landlord at the time of contracting, that causes or is likely to cause material disruption (hafra'a shel mamash) to the use of the apartment |
| Fix pre-existing defects | Disclosed defects must be remedied per the landlord's repair obligations |
...
| Register contract with tax authority | Landlord must report rental income to Mas Hachnasa. Residential rental income is fully tax-exempt up to 5,654 NIS/month (2026), with a partial exemption between 5,654 and 11,308 NIS/month |
...
| Landlord concealed a known defect | הסתרת פגם ידוע על ידי המשכיר | Breaches the section 25ב pre-contract disclosure duty; a known non-minor defect, or a known nuisance in the apartment's surroundings causing material disruption, must be disclosed before signing |
...
- When the broker acted on the landlord's behalf, the tenant cannot be charged the broker's fee (section 25ט). A contract clause making the tenant pay the landlord's share of the broker fee is void, not merely negotiable. Agents sometimes treat broker fees as freely assignable between the parties.
- The fair-rental provisions do not apply to every lease. Section 25טו excludes rent above 20,000 NIS/month (not indexed), leases over 10 years, leases under 3 months, family rentals, hotels and vacation lets, assisted living, dormitories, and protected tenancies. Applying the deposit cap or repair duties to an excluded lease is a common error.
