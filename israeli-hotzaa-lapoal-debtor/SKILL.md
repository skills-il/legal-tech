...
| MCP | Why |
|---|---|
| `kolzchut` | The Kol Zchut rights base carries the enforcement procedure pages this skill is built on. Use it to pull the current text of a procedure before relying on a figure, since the protected-wage amounts and the insolvency threshold are updated annually. |
