# Service inventions (Patents Law ss.132-135)
...
- A company filing over an invention made by a co-founder or early engineer, with no written IP assignment, is exposed to a Committee claim years later, potentially after a financing round or exit.
- Consultants and contractors are not employees, so section 132 does not capture their inventions by default. Their assignments must be contractual.
- The Committee sits at the same office that will examine the application, so this is not a distant litigation risk.

Confirm the chain of title, and the compensation position, with a licensed Israeli patent attorney or employment lawyer before filing.
