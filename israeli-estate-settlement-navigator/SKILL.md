...
- Do NOT tell the family that every charge is unlawful. The Bituach Leumi (Burial Grant) Regulations, 5736-1976 enumerate the cases where a burial society MAY lawfully charge on top of the grant. Regulation 3(a) permits a service fee or other payment, in connection with the burial and the erection of the headstone, in these cases only: burial in one of the closed cemeteries listed in the annex to the agreement, burial in defined premium sections agreed between Bituach Leumi and the society, or burial in a grave plot the deceased purchased in their lifetime. Regulation 4(a) permits a further payment that is not a service fee only for special costs of transferring the deceased from outside the society's area, a detour or stop requested by the family en route to the cemetery, or non-standard shrouds supplied at the family's request. One important limb sits outside both lists: under regulation 3(b), where the deceased is a person to whom section 266 of the Law does not apply (broadly, someone the burial-grant arrangement does not cover, such as a non-resident), the society may charge a service fee or any other payment. So establish first whether section 266 covers the deceased at all. If it does, check the demand against regulations 3(a) and 4(a): outside them, refuse; inside them, the charge is lawful. If it does not, the society is not bound by those lists and the price is a commercial matter to negotiate.
...
**How the order actually reaches the bank or the Tabu.** Do not tell the family the order arrives everywhere by itself, and do not tell them they must hand-deliver it either. The Registrar issues a digital order that is sent automatically by email to the applicant (or to the lawyer who represented them). Transmission onward is per-body and is triggered by the family: once a request for the action is filed, the Registrar sends the digital order directly to the banks, the insurance companies and the relevant government bodies, such as the Land Registry (the "Tabu"), the Ministry of Transport, the Israel Land Authority, the Tax Authority and the Corporations Authority, and for those bodies the family then does not need to present the order at the counter. So the instruction is: file the request for the action so the order is transmitted, and still keep the digital order (and a certified copy) to hand, because a body outside that transmission, or one that has not yet matched it to the file, will ask to see it. The digital-order service covers orders issued by the Registrar from 1998 onward.
...
- Do not tell the family they must pay the burial society, and do not tell them every charge is unlawful either. The grant covers standard burial directly, and where section 266 of the Law applies to the deceased the regulations allow a charge on top only in the enumerated cases (closed cemeteries, agreed premium sections, a pre-purchased plot, out-of-area transfer, a requested detour, non-standard shrouds). Where section 266 does not apply to the deceased, regulation 3(b) lets the society charge freely, so do not tell such a family the charge is unlawful. Check which situation applies before refusing on principle.
